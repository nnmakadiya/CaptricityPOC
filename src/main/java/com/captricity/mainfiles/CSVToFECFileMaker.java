...
public class CSVToFECFileMaker {
	...
	public static void main(String[] args) {
		try{
			...
			List<FECSummaryRecord> listFECScheARecords = ConvertCSVSummaryToFECSummary.convertCSVSheduleToFECShedule("export-66828.csv");
			
			//Pass schedule A Captricity csv file
			//List<FECScheduleARecord> listFECScheARecords = ConvertCSVScheAToFECScheA.convertCSVScheAToFECScheA("export-66829.csv");
			
			//Pass schedule B Captricity csv file
			//List<FECScheduleBRecord> listFECScheBRecords = ConvertCSVScheBToFECScheB.convertCSVScheBToFECScheB("export-66660.csv");
			
			//Pass schedule C Captricity csv file
			//List<FECScheduleCRecord> listFECScheCRecords = ConvertCSVScheCToFECScheC.convertCSVScheCToFECScheC("export-66656.csv");

			//Pass schedule C2 Captricity csv file
			//List<FECScheduleC2Record> listFECScheC2Records = ConvertCSVScheCToFECScheC2.convertCSVScheCToFECScheC2("export-66656.csv");
			
			//Pass schedule D Captricity csv file
			//List<FECScheduleDRecord> listFECScheDRecords = ConvertCSVScheDToFECScheD.convertCSVScheDToFECScheD("export-66655.csv");
			
			//Pass schedule C1 Captricity csv file
			//List<FECScheduleC1Record> listFECScheC1Records = ConvertCSVScheC1ToFECScheC1.convertCSVScheC1ToFECScheC1("export-66659.csv");
			...
			for(FECSummaryRecord fecSummaryRecord : listFECScheARecords){
